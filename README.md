...
* Small example game based on this ["game template"](https://niklasei.github.io/bevy_game_template/) (*warning: `bevy_kira_audio` was removed in favor of the built-in bevy-audio for sound*)
