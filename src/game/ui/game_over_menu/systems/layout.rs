...
pub fn spawn_game_over_menu(mut commands: Commands, font_assets: Res<FontAssets>) {
    build_game_over_menu(&mut commands, &font_assets);
}

pub fn build_game_over_menu(commands: &mut Commands, font_assets: &Res<FontAssets>) -> Entity {
